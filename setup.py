...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-sale_credit_limit_total',
    download_url='https://github.com:nantic/trytond-sale_credit_limit_total.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-sale_credit_limit_total.git'
    },
    classifiers=[
